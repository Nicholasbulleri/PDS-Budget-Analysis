...
SQL_FILE = os.path.join(SCRIPT_DIR, "budget_core_query_closed_by_category_with_state.sql")
OUT_CSV = "budget_query_results_curated_closed_by_category_with_state.csv"
