...
MAPPING_CSV = os.path.join(SCRIPT_DIR, "city_to_state_mapping.csv")
TEMPLATE_SQL = os.path.join(SCRIPT_DIR, "budget_core_query_closed_by_category_with_state.sql")
OUT_SQL = os.path.join(SCRIPT_DIR, "budget_core_query_closed_by_category_with_state_using_mapping.sql")
