...
SQL_FILE = os.path.join(SCRIPT_DIR, "budget_core_query_closed_by_category_exclude_missing_area.sql")
OUT_CSV = os.path.join(SCRIPT_DIR, "budget_query_results_curated_closed_by_category_with_state_using_mapping_excludes_missing_area.csv")
OUT_XLSX = os.path.join(SCRIPT_DIR, "budget_query_results_curated_closed_by_category_with_state_using_mapping_excludes_missing_area.xlsx")
