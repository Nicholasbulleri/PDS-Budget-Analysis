...
SQL_FILE = os.path.join(SQL_DIR, "closed_projects_missing_budget_by_business_line.sql")
OUT_CSV = os.path.join(PROJECT_ROOT, "data", "projects", "closed_projects_missing_budget_by_business_line.csv")
OUT_XLSX = os.path.join(PROJECT_ROOT, "data", "projects", "closed_projects_missing_budget_by_business_line.xlsx")
