...
SQL_FILE = os.path.join(SQL_DIR, "budget_core_query_closed_by_category_exclude_missing_area_with_property_sector.sql")
OUT_CSV = os.path.join(DATA_DIR, "budget_query_results_curated_closed_by_category_with_state_using_mapping_excludes_missing_area_with_property_sector.csv")
OUT_XLSX = os.path.join(DATA_DIR, "budget_query_results_curated_closed_by_category_with_state_using_mapping_excludes_missing_area_with_property_sector.xlsx")
