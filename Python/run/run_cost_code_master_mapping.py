#!/usr/bin/env python3
"""Run cost_code_master_mapping.sql and write results to CSV + XLS for dashboard reference."""
import os
...
SQL_FILE = os.path.join(SQL_DIR, "cost_code_master_mapping.sql")
OUT_CSV = os.path.join(PROJECT_ROOT, "data", "cost_codes", "cost_code_master_mapping.csv")
OUT_XLSX = os.path.join(PROJECT_ROOT, "data", "cost_codes", "cost_code_master_mapping.xlsx")
...
def main():
    ...
    print("Running cost code master mapping query...")
